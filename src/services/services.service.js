...
class ServicesService {
  async getServiceDetails() {
    try {
      ...
      if (!response.ok)
        throw new Error(
          "The fetch for service details info failed for some reason.",
        );
  ...
  async getServiceDetail(id) {
    try {
      ...
      if (!response.ok)
        throw new Error(
          "The fetch for service detail by ID failed for some reason.",
        );
      return response.json();
    } catch (error) {
      if (error instanceof Error) {
  ...
  async deleteService(id) {
    try {
      ...
      if (!response.ok)
        throw new Error(
          "The fetch for deleting service by ID failed for some reason.",
        );
      return response.json();
    } catch (error) {
      if (error instanceof Error) {
  ...
  async createService(service) {
    try {
      ...
      if (!response.ok)
        throw new Error(
          "The fetch for service creation failed for some reason.",
        );
      return response.json();
    } catch (error) {
      if (error instanceof Error) {
  ...
  async updateServiceDetails(data) {
    try {
      ...
      if (!response.ok)
        throw new Error(
          "The fetch for service update by ID failed for some reason.",
        );
      return response.json();
    } catch (error) {
      if (error instanceof Error) {
