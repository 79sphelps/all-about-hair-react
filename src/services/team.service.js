...
class TeamService {
  async getTeamDetails() {
    try {
      ...
      if (!response.ok)
        throw new Error("The fetch for team info failed for some reason.");
  ...
  async getTeamMemberDetail(id) {
    try {
      ...
      if (!response.ok)
        throw new Error(
          "The fetch for team member info by ID failed for some reason.",
        );
      return response.json();
    } catch (error) {
      if (error instanceof Error) {
  ...
  async deleteTeamMember(id) {
    try {
      ...
      if (!response.ok)
        throw new Error(
          "The fetch for deleting team member by ID failed for some reason.",
        );
      return response.json();
    } catch (error) {
      if (error instanceof Error) {
  ...
  async createTeamMember(member) {
    try {
      ...
      if (!response.ok)
        throw new Error(
          "The fetch for team member creation failed for some reason.",
        );
      return response.json();
    } catch (error) {
      if (error instanceof Error) {
  ...
  async updateTeamMemberDetails(data) {
    try {
      ...
      if (!response.ok)
        throw new Error(
          "The fetch for team member update by ID failed for some reason.",
        );
      return response.json();
    } catch (error) {
      if (error instanceof Error) {
