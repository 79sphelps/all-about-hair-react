...
//     let obj = getFormErrorObjectCreateService(name, value, formErrorObject);
//     let newObj = { ...formErrorObject, ...obj };
//     setFormErrorObject((values) => ({ ...values, ...newObj }));
...
//     // e.preventDefault();
//     const { name, value } = e.target;
//     let obj = getPricingDetailErrorObject(name, value, formErrorObject);
//     let newObj = { ...pricingDetailErrorObject, ...obj };
//     setPricingDetailErrorObject((values) => ({ ...values, ...newObj }));
//     setPricingDetails((values) => ({ ...values, [name]: value }));
//   };
...
//             })
//           : null,
//       errorMsg: formErrorObject.titleError && (
...
//             })
//           : null,
//       errorMsg: formErrorObject.imageError && (
...
//             })
//           : null,
//       errorMsg: pricingDetailErrorObject.typeError && (
...
//             })
//           : null,
//       errorMsg: pricingDetailErrorObject.priceError && (
...
//             })
//           : null,
//       errorMsg: pricingDetailErrorObject.description2Error && (
...
//                                   name={item.name}
//                                   value={item.value}
//                                   onChange={onPricingDetailUpdate}
//                                   onBlur={item.onBlur}
//                                 />
//                                 {item.errorMsg}
//                               </div>
